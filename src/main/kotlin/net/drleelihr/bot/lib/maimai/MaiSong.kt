...
import net.drleelihr.bot.lib.downloadImage
...
class MaiSong(json: JSONObject) {
    ...
    inner class Chart(json: JSONObject) {
        ...
        fun getProbeData(): Chart {
            ...
            chartProbeSummary = """
                ...
                其中${sssCount}人（${
                ((sssCount.toDouble() / playerCount.toDouble()) * 10000).toInt().toDouble() / 100
            }%）达成SSS
    ...
    fun getImageFile(): File {
        ...
        try {
            ...
            return File("$resourcePath\\maimai\\noImage.png")
        }
